...
public class Gun : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // 총 위치 업데이트 (offset을 X, Y 개별로 적용)
        Vector2 gunOffset = new Vector2(lastDirection.x * offset.x, lastDirection.y * offset.y - 0.1f);
        transform.position = (Vector2)player.position + gunOffset;
